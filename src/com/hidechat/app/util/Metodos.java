...
private static Context aContext=null;
    ...
    public static void configure(int threshold, int interval) {
        Metodos.threshold = threshold;
        Metodos.interval = interval;
    }
     ...
     */
    public static void startListening( Interface _interface ) 
    {
